...
% Oklart om sån här text borde stå under "implementation". Tänkte att neighbour-list detaljen borde göra det iaf,
% och isf är det svårt att inte säga något mer efter det.
